...
Abgabetermin für die schriftlichen Prüfungsleistungen ist der 30.09.2026. Die Abgabe erfolgt als PDF per Email sowie als
Ausdruck, mit Deckblatt und unterschriebener Eigenständigkeitserklärung an der Hauptpforte
oder im Briefkasten für Prüfungsleistungen in der LS4. **Die elektronische Abgabe per Email allein genügt für Hausarbeiten, Essays und THK nicht!**
...
| **13.04.2026** | **Eröffnung, Organisatorisches** | **Referat** |
|------------|------------------------------|---------|
| 20.04.2026 | Lambert Wiesing: Was ist Medienphilosophie? | kein Referat |
| 27.04.2026 | Film- und Medienethik (Vorlesungs- und Übungssitzung) | kein Referat |
| 04.05.2026 | Walter Benjamin: Das Kunstwerk im Zeitalter seiner technischen Reproduzierbarkeit. In: Ziemann (Hg.): Grundlagentexte der Medienkultur. Wiesbaden 2019 | Referat |
| 11.05.2026 | Marshall McLuhan: Understanding Media (Auszug) | Referat |
...
Der Hintergrund des Versuchs war die aktuelle Diskussion im philosophischen Seminar über die Funktionälität von Prüfungsleistungen wie der THK in Anbetracht der aktuellen technischen Fortschritte im Bereich von textgenerierender KI.
